...
namespace MomobamiRirika.Models
{
    ...
    public class TrafficRegion:TrafficItem
    {
        ...
        /// </summary>
        [NotMapped]
        public string MatchId => Channel?.DensityDevice_DensityChannel == null ? null : $"{Channel.DensityDevice_DensityChannel.Device.Ip}_{Channel.ChannelIndex}_{RegionIndex}";
