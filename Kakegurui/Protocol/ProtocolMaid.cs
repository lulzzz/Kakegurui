...
namespace Kakegurui.Protocol
{
    ...
    public class ProtocolMaid:SocketMaid
    {
        ...
        /// <param name="e"></param>
        protected void ProtocolReceiveHandler(object sender, ReceivedEventArgs e)
        {
            if (e.ProtocolId == Convert.ToUInt16(ProtocolId.CollectStatus))
            {
                CollectStatus(e);
            }
            else if (e.ProtocolId == Convert.ToUInt16(ProtocolId.Shoot))
            {
                Shoot(e);
            }
        }
