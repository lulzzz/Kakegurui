...
namespace MomobamiKirari.Managers.Cluster
{
    ...
    public class VideoStructManager_Cluster : VideoStructManager
    {
        ...
        public override PageModel<VideoStruct> QueryList(List<Lane> lanes, VideoStructType structType, DateTime startTime, DateTime endTime, int pageNum, int pageSize, bool hasTotal)
        {
