...
namespace MomobamiKirari.Managers.Cluster
{
    /// <summary>
    /// 流量数据集群查询
    /// </summary>
    public class LaneFlowManager_Cluster : LaneFlowManager
    {
        ...
        public override List<List<TrafficChart<DateTime, int, LaneFlow>>> QueryCharts(List<Lane> lanes, DateTimeLevel level, DateTime[] startTimes, DateTime[] endTimes,DateTime baseTime, FlowType[] flowTypes = null)
        { 
        ...
        public override List<List<LaneFlow>> QueryList(List<Lane> lanes, DateTimeLevel level, DateTime[] startTimes, DateTime[] endTimes)
        {
