...
namespace MomobamiKirari.Controllers
{
    ...
    public class ChannelFlowsController
    {
        ...
        public ChannelFlowsController(LaneFlowManager flowManager, IMemoryCache memoryCache, IDistributedCache distributedCache)
        {
        ...
        public ChannelDayFlow QueryChannelDayStatus([FromRoute]string channelId)
        {
            ...
            if (flowCache == null)
            {
                ...
                foreach (TrafficLane lane in lanes.OrderBy(l => l.LaneIndex))
                {
                    //上月和去年天从数据库查询
        ...
        public ChannelMinuteFlow QueryChannelMuniteStatus([FromRoute]string channelId)
        {
            ...
            TrafficChannel channel = _memoryCache.GetChannel(channelId);
            if (channel!=null)
            {
                ...
                foreach (TrafficLane lane in channel.Lanes)
                {
